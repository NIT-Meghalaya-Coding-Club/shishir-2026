        ...
        <div className="flex justify-center mb-12 md:mb-20">
          <div className="relative w-32 h-32 md:w-48 md:h-48 lg:w-56 lg:h-56">
            <Image
              src="/assets/logo.png"
              alt="SHISHIR Logo"
              width={224} // Based on largest size (56px * 4 for lg:w-56)
              height={224} // Same as width since it's square
              priority
        ...
        <div className="space-y-16 md:space-y-24">
          ...
          <div className="flex flex-col items-center md:items-end max-w-4xl mx-auto md:ml-auto">
            <p className="text-[#ffd960] text-base md:text-lg lg:text-xl leading-relaxed text-center md:text-right font-light tracking-wide max-w-3xl">
              ...
              <span className="font-semibold">SHISHIR</span>, the Annual
              Cultural Fest of the National Institute of Technology, Meghalaya.
              Here, amidst the harmonious blend of nature and culture,
              you&apos;ll be transported to a realm where time stands still,
              allowing you to relive moments of pure magic.
            </p>
          </div>
          ...
          <div className="max-w-3xl mx-auto space-y-6">
            <p className="text-[#ffd960] text-base md:text-lg lg:text-xl leading-relaxed font-light tracking-wide text-center md:text-left">
              <span className="font-semibold">NIT Meghalaya</span> extends a
              warm welcome to all, as we prepare for Meghalaya&apos;s grandest
              cultural extravaganza. Join us in celebrating the rich tapestry of
              cultures, where every tradition converges on a single stage,
              amidst the crisp mountain air, promising to etch unforgettable
