...
const SACLetter: React.FC = () => {
  return (
    <CardWrapper title="Letter from SAC President">
      ...
      <p className="py-3">
        Since our inaugural session in 2023, NITMMUN has grown from a nascent
        conference into a cornerstone event that exemplifies the analytical
        rigor and diplomatic finesse expected of future leaders. Our second
        conference in 2024 built upon this foundation, expanding its scope and
        depth, engaging delegates in more intense and diverse deliberations that
        tested their resolve and honed their skills.
      </p>
      <p className="py-3">
        This year, we proudly host NITMMUN alongside <strong>Shishir</strong>,
        ...
        excellence. This synergy not only enriches our campus culture but also
        offers participants a holistic view of the vibrancy that NIT Meghalaya
        has to offer.
      </p>
      <p className="py-3">
        ...
        Delegates who once navigated the complexities of international policies
        and negotiations in our committees have gone on to excel in various
        professional fields, embodying the spirit of global citizenship and
        cooperation.
      </p>
      <p className="py-3">
        Our 2023 edition set the precedent with its innovative agendas and
        inclusive debate forums. The following year, in 2024, we delved deeper
        into pressing global issues, fostering a culture of critical thinking
