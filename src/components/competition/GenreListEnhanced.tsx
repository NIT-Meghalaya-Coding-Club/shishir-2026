      ...
      {genres.map((genre, index) => (
        ...
        >
          <div className="px-8 pt-8 pb-4">
            <div className="absolute top-0 right-0 -mt-4 -mr-4 w-20 h-20 bg-yellow-500 rotate-45 opacity-20 group-hover:opacity-40 transition-opacity duration-300"></div>
            <motion.h3
