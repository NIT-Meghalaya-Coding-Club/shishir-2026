    ...
    <div className='w-full pt-20 h-screen flex flex-col sm:flex-row lg:flex justify-center items-center '
        ...
        <div className='text sm:w-1/3 sm:h-2/3 backdrop-blur-sm bg-white/10 bg-opacity-70 rounded-none sm:rounded-s-xl'>
            ...
            <div className='sm:h-1/2'>
                <h1 className='text-md sm:text-2xl px-10 text-center text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 via-yellow-500 to-yellow-500'>The Dev team is working hard
                to bring this page back to life</h1>
                <h4 className='text-sm sm:text-md p-5 text-[#3d3125] font-bold text-center'>meanwhile, why don’t you try going</h4> 
