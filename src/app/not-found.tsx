...
const NotFoundPage = () => {
  ...
  return (
    <div
      className="w-full min-h-screen flex flex-col justify-center items-center pt-24 pb-12 px-4"
      style={{
        background:
          "radial-gradient(circle at center, #0A1128 0%, #001F54 60%, #000000 100%)",
    ...
    >
      <div className="max-w-4xl w-full p-6 flex flex-col sm:flex-row gap-8 items-center justify-center">
        <div
          className="backdrop-blur-md bg-black/40 rounded-xl p-8 text-center flex flex-col items-center shadow-2xl border border-gold-500"
          style={{ borderColor: "#D4AF37" }}
        >
          <h1
            className="text-4xl sm:text-6xl font-bold mb-6 text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 to-yellow-600"
          ...
          <div
            className={`transition-all duration-300 mb-8 ${
              bounceEffect ? "transform scale-110" : ""
            }`}
          >
        ...
        <div className="w-full sm:w-1/2 flex justify-center items-center">
          <div className="relative w-full aspect-square max-w-md">
            ...
            />
            <div
              className="absolute -top-10 -right-10 bg-yellow-500 text-black p-3 rounded-full transform rotate-12 border-2 border-black font-bold text-xl"
              style={{
      ...
      <div
        className="fixed top-32 left-10 w-20 h-20 rounded-full opacity-20"
        style={{
      ...
      <div
        className="fixed bottom-20 right-10 w-32 h-32 rounded-full opacity-20"
        style={{
          background: "radial-gradient(circle, #D4AF37 0%, #AA8C2C 100%)",
          boxShadow: "0 0 30px 15px rgba(212, 175, 55, 0.4)",
